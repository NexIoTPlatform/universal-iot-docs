...
features:
  ...
  - icon: 🏢
    title: 企业级架构设计
    details: 基于Java21 + SpringBoot 3.5，支持百万级设备接入，MySQL8.0+、Redis、MQTT，轻松应对大规模部署
  - icon: 📊
    title: 模块化插件架构
...
- ✅ **极简架构**：Java21、mysql5.8+、redis、MQTT（不限emqx还是其他），轻松应付百万级别的设备;支持clickhouse存储（配置就行）
...
- **账号密码**：请到项目主页获取最新测试账号密码：https://gitee.com/NexIoT/Universal-IoT-Java
...
![教程成果动画](/shot/dianbiao.gif)

## 🚀 快速开始

<!-- - **📖 [平台介绍](/guide/intro)** - 了解平台架构和核心功能 -->
- **⚡ [快速开始](/quick-start-guide)** - 5分钟快速部署指南
- **🔌 [设备接入](/device-access)** - 多协议设备接入方案
- **📺 [视频教程](/tutorials)** - 实战视频教程集合

## 📋 产品动态

- **📝 [系统更新日志](/04.系统更新日志/01.版本历史/01.最新版本)** - 最新版本更新和功能发布
- **🗺️ [发展路线图](/05.发展路线图/01.产品愿景/01.产品定位)** - 产品发展规划和未来愿景
- **🎯 [案例分享](/06.案例分享/01.成功案例/01.企业级部署)** - 真实用户案例和最佳实践
- **🆘 [帮助支持](/07.帮助支持/01.常见问题/01.安装部署问题)** - 常见问题和技术支持

## 📺 视频教程

### 天翼物联设备接入实战系列

- **[NB水浸传感器开箱](/iot/aiot/create-product#1-nb水浸传感器开箱与硬件解析)** - 硬件解析和功能介绍
- **[Ctwing参数配置](/iot/aiot/create-product#2-ctwing参数配置实战)** - 平台参数配置实战
- **[完整接入流程](/iot/aiot/create-product#3-nb水浸传感器ctwing接入全流程)** - 从设备到平台的全流程演示
